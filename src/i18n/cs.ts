...
export const t: Translations = {
  ...
  sections: {
    about: {
      heading: "O mně",
      paragraphs: [
        `Ahoj, jsem Lukáš. Jsem <strong>.NET vývojář</strong> s 15 lety praxe. Pomáhal jsem stavět aplikace pro víc než 20 firem.`,
        `Moje hlavní doména je backend – REST API, .NET MVC a návrh celkové architektury. Postupem času jsem ale zabrousil i do frontendu. Zkoušel jsem Vue a nakonec zakotvil u Reactu. I když nejsem primárně frontendista, v moderním UI kódu se v pohodě orientuju a zvládnu aplikaci postavit od A do Z.`,
        `Kromě programování mě baví i učit. Přes 5 let jsem v <strong>Gopasu</strong> školil .NET a webový vývoj. Dneska občas něco sdílím na svůj <a href="https://www.linkedin.com/in/luk%C3%A1%C5%A1-kmoch/" target="_blank" class="linkedin-link">LinkedIn profil</a> a ve volném čase hodně zkouším, co reálně dokáže AI (Claude Code, OpenClaw) a jak tyhle nástroje nejlíp zapojit do denního vývoje.`,
      ],
    },
